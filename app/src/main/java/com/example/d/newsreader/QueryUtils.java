...
public class QueryUtils {
    ...
    private static final String GUARDIAN_URL = "https://content.guardianapis.com/search?q=chess&from-date=2017-01-01&api-key=test";
    ...
    public static List<Article> extractArticles() {
        ...
        try {
            ...
            for (int i = 0; i < results.length(); i++) {
                ...
                articles.add(new Article(title, section, articleUrl));
            }
